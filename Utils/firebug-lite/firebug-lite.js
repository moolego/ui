var firebug = {
    version:[1.21,200809],
    el:{}, env:{ "cache":{}, "override":false, "css":"../Utils/firebug-lite/firebug-lite.css", "dIndex":"console", "height":295, "init":false, "minimized":false, "ml":false },
    init:function(_css){
        with(firebug){
            ...
            document.getElementsByTagName("head")[0].appendChild(
                new lib.element("link").attribute.set("rel","stylesheet").attribute.set("href",firebug.env.css||"firebug-lite.css").element
            );
             ...
             */
            el.content = {};
			el.winwin = new UI.Window();
            el.main = new lib.element("DIV").attribute.set("id","Firebug").environment.addStyle({ "display":"none", "width":lib.util.GetViewport().width+"px" }).insert(el.winwin.content);
